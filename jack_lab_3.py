...
def detect_waveform(samples):
    ...
    if 0.81 < crest_factor <  0.85 and 1.2 < form_factor < 1.28:
        return "Sine Wave"
    elif 0.7 < crest_factor < 0.73 and 1.37 < form_factor < 1.43:
        return "Square Wave"
    elif 0.86 < crest_factor < 0.9 and 1.1 < form_factor < 1.36:
